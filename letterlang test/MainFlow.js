...
function blank1secRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of blank1secComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function letter1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of letter1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function letter2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of letter2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function letterselectRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of letterselectComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
