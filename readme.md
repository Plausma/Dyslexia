...
The two word choices can be classified into 3 pair: correct and incorrect variant
...
The word lengths will range from 3 to 7 letters, with 20 words for each length, totaling 100 words. Each word has 3 incorrect variations including greek, scramble, and pseudo word (4 in total), 400 trials overall.
